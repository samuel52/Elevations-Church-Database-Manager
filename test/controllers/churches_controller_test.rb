...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { email: @church.email, fname: @church.fname, friend: @church.friend, lname: @church.lname, member: @church.member, phone: @church.phone, rsvp: @church.rsvp } }
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { email: @church.email, fname: @church.fname, friend: @church.friend, lname: @church.lname, member: @church.member, phone: @church.phone, rsvp: @church.rsvp } }
